...
if CanIMogIt.isRetail then
    EVENTS.insert("AUCTION_HOUSE_SHOW")
    EVENTS.insert("AUCTION_HOUSE_BROWSE_RESULTS_UPDATED")
    EVENTS.insert("AUCTION_HOUSE_NEW_RESULTS_RECEIVED")
    EVENTS.insert("PLAYERREAGENTBANKSLOTS_CHANGED")
end
